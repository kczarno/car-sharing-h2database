...
public class DatabaseService {
    ...
    static String DB_URI = "jdbc:h2:file:./src/carsharing/db/";
    ...
    static void createANewCar(String name, int companyId) {
    ...
    static ArrayList<Car> getCars(int companyId) {
    ...
    static void createANewCustomer(String name) {
    ...
    static ArrayList<CustomerAccount> getCustomers() {
    ...
    static void getCustomerRentedCar(CustomerAccount customerAccount) {
                    ...
                    while (customer.next()) {
                        ...
                        if (customer.getObject(3) != null) {
                            ...
                            if (companies.size() == 0) {
                                ...
                                ArrayList<Car> carList = DatabaseService.getCars(companyId);
